...
class PrimaryTower: CharacterCard {
    ...
    override init(image: UIImage, name: String, cardDescription: String, manaCost: Int, summoningTime: Int, level: Int, xp: Int, atackPoints: Int, atackSpeed: CGFloat, atackArea: Int, atackRange: CGFloat, speed: Int, healthPoints: Int, battleScene: BattleScene, teamId: Int, cardImage: UIImage, atackEffect: String) {
        super.init(image: image, name: name, cardDescription: cardDescription, manaCost: manaCost, summoningTime: 0, level: level, xp: xp, atackPoints: 25, atackSpeed: 0.5, atackArea: 1, atackRange: atackRange, speed: 0, healthPoints: 2000, battleScene: battleScene, teamId: teamId, cardImage: cardImage, atackEffect: "arrow")
